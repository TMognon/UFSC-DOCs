		...
		<div class="card-text-center">	
			...
			<div class="card-body">	
				...
				<div class="jumbotron jumbotron-fluid">
				  <div class="container">
				    <p class="lead"><strong>Atenção!<strong> Este site foi desenvolvido por um humano e está suscetível a erros como qualquer merda que eu faço, então dê uma conferida no edital antes de botar pra foder</p>
				  </div>
				</div>
